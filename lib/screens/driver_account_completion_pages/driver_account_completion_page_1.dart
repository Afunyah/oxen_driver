...
class DriverAccountCompletionPage1Widget extends StatefulWidget {
  DriverAccountCompletionPage1Widget({Key? key}) : super(key: key);

  @override
  _DriverAccountCompletionPage1WidgetState createState() =>
      _DriverAccountCompletionPage1WidgetState();
}

class _DriverAccountCompletionPage1WidgetState
    extends State<DriverAccountCompletionPage1Widget> {
